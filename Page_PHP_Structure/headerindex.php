    ...
    <title>Voie Lactée</title>
    <!--Titre de notre Site-->
    <meta name='description' content='Tout sur le Systeme Solaire' >
    <!--Description de la page-->
    <meta
      name='keywords'
      content='système solaire, planètes, soleil, terre, accueil '
    >
    <!--Mots clé de la page-->
    <meta
      name='viewport'
